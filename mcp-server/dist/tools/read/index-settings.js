...
export function registerIndexSettings(server) {
    server.registerTool("index_settings", {
        title: "Index Settings",
        description: "Get all settings for an index including defaults: shard count, replica count, " +
        ...
        const qs = include_defaults
            ...
            : "?flat_settings=true";
        const result = await esFetch("GET", `/${encodeURIComponent(index)}/_settings${qs}`);
        return {
