...
export function registerFieldCaps(server) {
    server.registerTool("field_caps", {
        title: "Field Capabilities",
        description: "Per-field capabilities: type, searchable, aggregatable flags. " +
        ...
        const result = await esFetch("GET", `/${encodeURIComponent(index)}/_field_caps?fields=*`);
        return {
            content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    });
}
//# sourceMappingURL=field-caps.js.map